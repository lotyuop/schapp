...
class BdcClient(models.Model):
    ...
    bank = models.ForeignKey(Banks, blank=True, verbose_name="Client Bank", on_delete=models.CASCADE, null=True);
    acct = models.CharField(max_length=18, verbose_name='client account',blank=True)
...
class BdcTranzactions(models.Model):
    ...
    bank = models.ForeignKey(Banks, on_delete=models.CASCADE, verbose_name="Client Bank")
